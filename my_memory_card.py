...
questions_list.append(Question('Домашнее животное', 'Кот', 'Тигр', 'Лев', 'Пума'))
questions_list.append(Question('Название овоща', 'Картофель', 'Лимон', 'Яблоко', 'Апельсин')) 
questions_list.append(Question('Язык данного проекта', 'Python', 'Java', 'PHP', 'C#')) 
app = QApplication([])
